...
public class PersonServiceImpl implements PersonService {
    ...
    public PersonDTO updatePerson(long personId, PersonDTO personDTO) {
        ...
        PersonDTO updatedPerson = addPerson(personDTO);
    ...
    @Override
    public Long getPersonIdByIdentificationNumber(String identificationNumber) {
        return personRepository.findByIdentificationNumber(identificationNumber).getId();
    }

    @Override
    public List<PersonStatisticDTO> getPersonStatistics() {
        List<PersonStatisticEntity> allRevenue = invoiceRepository.findAllRevenue();
        return allRevenue
                .stream()
                .map(i -> personMapper.toDTO(i))
                .collect(Collectors.toList());
     ...
     */
    private PersonEntity fetchPersonById(long personId) {
        return personRepository.findById(personId)
                .orElseThrow(() -> new NotFoundException("Person with id " + personId + " wasn't found in the database."));
    }
